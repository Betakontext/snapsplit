Diese erste Version eines Addons „SnapSplit“ für Blender (5.0.1) automatisiert das Zerlegen komplexer 3D‑Modelle in druckbare Einzelteile und generiert präzise, passgenaue Steckverbindungen ohne Kleber.

Es integriert sich in einen 3D‑Druck‑Workflow (Toleranzen, Ausrichtung, Bauraum, Stützvermeidung) und nutzt robuste Booleans, adaptive Toleranzmodelle und Drucker-/Materialprofile.
...
Das Addon enthält:
    ...
    Operatoren:
        ...
        -   Gitter Split auf der Schnittfläche mit Zeilen und Spalteninput
        -   Prozentuale Einstellung des Abstands der Verbindungen zum Rand des Objekts
        -   Einstellung der Einstecktiefe. Default: 50%
        -   Automatische Platzierung und Erzeugung der      Steckverbindungen


Dies ist ein solides Startgerüst. Die Geometriealgorithmen sind auf Robustheit ausgelegt, aber minimal gehalten. Später können Freiform‑Nähte, Bajonett, Schwalbenschwanz, Magnettaschen, Support‑Aware Features usw. ergänzt werden.

Installation

    Lege die unten gezeigte Ordnerstruktur an und zippe den Ordner „snapsplit“ (nicht den Inhalt, sondern den Ordner selbst).
...
Hinweise zur Verwendung
    ...
    N‑Panel → SnapSplit:
        Erwünschte Teileanzahl und Schnittachse wählen.
    ...
    „Verbinder hinzufügen“ klicken.

    Pins/Zapfen werden auf einer gedachten Nahtlinie oder Fläche verteilt:
...
Grenzen und nächste Schritte
    ...
    Verbinder werden aktuell entlang einer groben Mittellinie
    oder auf der Fläche platziert.

    Skizze für spätere Versionen:
        ...
        Export‑Operator (3MF mit Metadaten),
        QA‑Panel (Manifold-/Wandstärke‑Checks),
...
The project is made with AI assistance (GPT 5) and under MIT license.

If you want to jump in for further development, fork and explore the code. Have fun splitting and printing.
